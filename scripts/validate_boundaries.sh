...
message_attention_files='examples/moontown_miniapp/message_attention_model.mbt examples/moontown_miniapp/message_attention_panel.mbt examples/moontown_miniapp/message_attention_rows.mbt examples/moontown_miniapp/message_attention_reviews.mbt examples/moontown_miniapp/message_attention_work_rows.mbt examples/moontown_miniapp/message_attention_render.mbt'
